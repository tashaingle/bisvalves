      ...
      <div className="mx-auto max-w-[1440px] px-5 md:px-10">
        ...
        <div className="mt-16 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          {featured.map((cat, i) => (
            ...
            >
              <div className="relative flex min-h-[220px] items-center justify-center bg-[#f6f6f4] p-8">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
                  src={cat.image}
                  alt=""
                  className="max-h-52 w-auto object-contain transition duration-500 group-hover:scale-105"
                />
              </div>
              <div className="flex flex-1 flex-col p-6">
                ...
                <h3 className="mt-2 font-display text-2xl tracking-tight text-night uppercase md:text-3xl">
                  {cat.name}
                </h3>
                <p className="mt-3 text-sm text-night/70">{cat.hover}</p>
                <span className="mt-5 inline-flex items-center gap-3 font-mono text-[11px] tracking-[0.22em] text-night uppercase">
                  View range
